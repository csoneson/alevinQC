...
[@Srivastava2018-fz] run. The QC report can be generated as a html or pdf file,
or launched as a shiny application.

# Installation

Currently, `alevinQC` can be installed from GitHub, using e.g. the `BiocManager`
CRAN package.
...
```{r v4}
baseDir <- system.file("extdata/alevin/neurons_900", package = "tximportData")
