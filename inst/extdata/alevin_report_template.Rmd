...
barcode are discarded. After quantification, a refinement of the cell barcode
whitelist is performed, with the aim to exclude low quality cells. The color in
the figure below indicates whether a cell barcode is included in this final
whitelist.
